...
import 'package:fleasnitch/ui/screens/cart/order_successful.dart';
...
class _SummaryScreenState extends BaseState<SummaryScreen> with BasicScreen {
  String sizeSelected = sizeList[0].sizeText;
  int quantity = 1;
  @override
                                              ...
                                              builder: (ctx) {
                                                return ProductDetailSheet(
                                                  ...
                                                  itemDescription:
                                                      "Stylish Women Sandal Block Heel Heel Heel Heel Heel Heel ",
                                                  itemPrice: "₹268",
                                                  selectedSize: sizeList[0].sizeText,
                                                  quantity: quantity,
                                                  valueChanged: (val) {
                                                    setState(() {
                                                      sizeSelected = val;
                    ...
                    child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(context,
                              MaterialPageRoute(builder: (ctx) => OrderSuccessful()));
                        },
                        child: getSmallText(
                          payNow,
                          weight: FontWeight.w700,
